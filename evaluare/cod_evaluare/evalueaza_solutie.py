def evaluate_results_task1(predictions_path, ground_truth_path, verbose=0):
    ...
    for i in range(1, 21):
        ...
        try:
            ...
            print("Filename ", filename_predictions, "doesnt exist")
            continue
        ...
        for row in range(1, 10):
            ...
            # print(p_line)
            # print(gt_line)
            if (p_line[:9] != gt_line[:9]):
                correct_flag = 0
        p.close()
        gt.close()

        if verbose:
            print("Task 1 - Classic Sudoku: for test example number ", str(i), " the prediction is :",
                  (1 - correct_flag) * "in" + "correct", "\n")
    ...
    for i in range(1, 21):
        ...
        if verbose:
            print("Task 1 bonus - Classic Sudoku: for test example number ", str(i), " the prediction is :",
                  (1 - correct_flag) * "in" + "correct", "\n")
...
def evaluate_results_task2(predictions_path, ground_truth_path, verbose=0):
    ...
    for i in range(1, 41):
        ...
        for row in range(1, 10):
            p_line = p.readline()
            gt_line = gt.readline()
            if (p_line[:18] != gt_line[:18]):
                correct_flag = 0

        p.close()
        gt.close()
        if verbose:
            print("Task 2 - Jigsaw Sudoku: for test example number ", str(i), " the prediction is :",
                  (1 - correct_flag) * "in" + "correct", "\n")
        total_correct = total_correct + correct_flag
    ...
    for i in range(1, 41):
        ...
        if verbose:
            print("Task 2 bonus - Sudoku Jigsaw: for test example number ", str(i), " the prediction is :",
                  (1 - correct_flag) * "in" + "correct", "\n")
...
predictions_path_root = "../fisiere_solutie/Sociu_Daniel_342/"
...
total_correct_task1, points_task1, total_correct_bonus_task1, points_bonus_task1 = evaluate_results_task1(
...
total_correct_task2, points_task2, total_correct_bonus_task2, points_bonus_task2 = evaluate_results_task2(
    predictions_path, ground_truth_path, verbose)
